...
<?php $darkSections = '.capa'; include 'nav.php'; ?>
        <div class="capa">
...
<div class="clientes">
    ...
    <div class="clientes_carrossel_wrap">
        <button class="clientes_seta clientes_seta-esquerda" onclick="clientesScroll(-1)" aria-label="Clientes anteriores">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function atualizarSetas(){
        const setaEsquerda = document.querySelector('.clientes_seta-esquerda');
        const setaDireita = document.querySelector('.clientes_seta-direita');
        if (!setaEsquerda || !setaDireita) return;
        const maxScroll = carrossel.scrollWidth - carrossel.clientWidth;
        setaEsquerda.disabled = carrossel.scrollLeft <= 2;
        setaDireita.disabled = carrossel.scrollLeft >= maxScroll - 2;
    }
...
function clientesScroll(direcao) {
    const carrossel = document.querySelector('.clientes_carrossel');
    carrossel.scrollBy({ left: direcao * carrossel.clientWidth, behavior: 'smooth' });
}
</script>
